...
const STAT_KEYS = [
  {
    ...
    label: "Strength",
    short: "STR",
    desc: "Physical power — lifting capacity, muscle mass",
  },
  {
    key: "agility",
    label: "Agility",
    short: "AGI",
    desc: "Speed, cardio fitness, reaction time",
  },
  {
    key: "vitality",
    label: "Vitality",
    short: "VIT",
    desc: "Endurance, consistency, recovery rate",
  },
  {
    key: "intelligence",
    label: "Intelligence",
    short: "INT",
    desc: "Nutrition knowledge, form accuracy",
  },
  {
    key: "perception",
    label: "Perception",
    short: "PER",
    desc: "Mind-muscle connection, body awareness",
  },
  {
    key: "luck",
    label: "Luck",
    short: "LUK",
    desc: "Random bonus events, surprise drops",
  },
] as const;
            ...
            <div className="p-4 grid grid-cols-1 sm:grid-cols-3 gap-3">
              {[
                ...
                },
                {
                  ...
                  desc: "Reach Monarch rank",
                  earned: false,
                  icon: "👑",
                },
                {
                  title: "Perfect Form",
                  desc: "100 AI form score",
                  earned: false,
                  icon: "💎",
                },
                {
                  title: "Arise",
                  desc: "Raise 20 soldiers",
                  earned: false,
                  icon: "🌟",
                },
                ...
                >
                  ...
                  <div>
                    <p
                      className={`font-mono text-xs font-bold ${earned ? "text-gold" : "text-slate-600"}`}
                    >
                      {t}
                    </p>
