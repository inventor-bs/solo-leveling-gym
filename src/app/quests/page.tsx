...
const QUEST_TYPE_STYLE = {
  main: {
    ...
    border: "border-monarch-purple/40",
    bg: "bg-monarch-purple/5",
    icon: "⚔️",
  },
  side: {
    label: "SIDE QUEST",
    color: "text-system-blue",
    border: "border-system-blue/30",
    bg: "bg-system-blue/5",
    icon: "◈",
  },
  hidden: {
      ...
      <div className="relative z-10 max-w-4xl mx-auto space-y-6">
                ...
                >
                  <div className="p-4">
                    ...
                    <p className="font-mono text-xs text-slate-400 italic mb-4">
                      {isHidden && !quest.completed
                        ? "Conditions unknown. The System watches."
                        : quest.description}
                    </p>
                              ...
                              <div className="h-1.5 bg-shadow-dark rounded-full overflow-hidden">
                                <motion.div
                                  className={clsx(
                                    "h-full rounded-full",
                                    quest.type === "main"
                                      ? "bg-gradient-to-r from-monarch-purple to-system-blue"
                                      : "bg-system-blue/70",
                                  )}
                                  initial={{ width: 0 }}
                                  animate={{ width: `${pct}%` }}
        ...
        >
          <div className="system-panel-inner flex items-center gap-3">
            ...
            <div>
              <p className="font-mono text-xs text-danger font-bold tracking-widest">
                PENALTY ZONE WARNING
              </p>
              <p className="font-mono text-xs text-slate-400 mt-0.5">
                Failure to complete the Main Quest before reset will activate
                the Penalty Zone Protocol. The System shows no mercy.
              </p>
            </div>
          </div>
        </motion.div>
