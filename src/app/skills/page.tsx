...
const SKILLS = [
  // Active
  {
    ...
    level: 10,
    maxLevel: 10,
    desc: "Extract and command fallen shadows.",
    locked: false,
    icon: "🌑",
  },
  {
    ...
    level: 5,
    maxLevel: 10,
    desc: "Perfect conventional deadlift form. STR +5%.",
    locked: false,
    icon: "🏋️",
  },
  {
    id: "bench",
    name: "Bench Press Protocol",
    type: "active",
    level: 4,
    maxLevel: 10,
    desc: "Optimal chest activation. STR +4%.",
    locked: false,
    icon: "💪",
  },
  {
    ...
    level: 3,
    maxLevel: 10,
    desc: "High intensity interval training. AGI +8%.",
    locked: false,
    icon: "⚡",
  },
  {
    ...
    level: 1,
    maxLevel: 5,
    desc: "Command all muscles simultaneously. All stats +2%.",
    locked: false,
    icon: "👑",
  },
  {
  ...
  // Passive
  {
    ...
    level: 2,
    maxLevel: 5,
    desc: "Recovery rate +20% when sleeping 7+ hours.",
    locked: false,
    icon: "🌙",
  },
  {
    ...
    level: 1,
    maxLevel: 5,
    desc: "Nutrient absorption +15%. Buff items +10% effect.",
    locked: false,
    icon: "🥗",
  },
  {
    ...
    level: 3,
    maxLevel: 10,
    desc: "Permanent STR +3 per level.",
    locked: false,
    icon: "🔩",
  },
  {
    ...
    level: 2,
    maxLevel: 5,
    desc: "Detect muscle imbalances automatically.",
    locked: false,
    icon: "👁️",
  },
  {
    ...
    level: 2,
    maxLevel: 5,
    desc: "Willpower stat. Reduces streak break chance.",
    locked: false,
    icon: "🧠",
  },
  {
  ...
  return (
    <div className="relative min-h-screen bg-void p-6 md:p-8">
      ...
      <div className="relative z-10 max-w-4xl mx-auto space-y-6">
        ...
        {[
          { label: "ACTIVE SKILLS", items: active },
          { label: "PASSIVE SKILLS", items: passive },
        ].map(({ label, items }) => (
          <motion.div
            key={label}
            initial={{ opacity: 0, y: 20 }}
                      ...
                      <div className="flex items-center gap-2">
                        <h3
                          className={clsx(
                            ...
                            skill.locked ? "text-slate-600" : "text-white",
                          )}
                        >
