      ...
      <div className="relative z-10 max-w-4xl mx-auto space-y-6">
        ...
        >
          ...
          <p className="font-mono text-sm text-slate-400 mt-1">
            The record of the Shadow Monarch&apos;s journey.
          </p>
        </motion.div>
          ...
          <SystemPanel header="PERSONAL RECORDS (PRs)">
            <div className="p-4 grid grid-cols-2 sm:grid-cols-3 gap-3">
              {[
                ...
                <div
                  key={exercise}
                  className="p-3 rounded-lg bg-gold/5 border border-gold/20 text-center"
                >
                  <p className="font-mono text-xs text-slate-500">{exercise}</p>
                  <p className="font-cinzel text-lg font-black text-gold">
                    {value}
                  </p>
              ...
              {DUNGEON_HISTORY.map((d, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 text-right flex-shrink-0">
                    <span
                      className={`font-mono text-xs font-bold ${RANK_COLOR[d.rank]}`}
                    >
                      [{d.rank}]
                    </span>
