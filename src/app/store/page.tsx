...
const STORE_ITEMS = [
  {
    id: "hp-low",
    name: "Low-Grade HP Potion",
    type: "consumable",
    grade: "common",
    price: 50,
    icon: "💊",
    effect: "Restore HP +100. Reduce DOMS.",
  },
  {
    id: "hp-mid",
    ...
    price: 200,
    icon: "💊",
    effect: "Restore HP +200. Accelerate recovery.",
  },
  {
    id: "hp-high",
    ...
    price: 500,
    icon: "💊",
    effect: "Full recovery. STR +1 for 24h.",
  },
  {
    id: "mana",
    name: "Mana Elixir",
    ...
    price: 300,
    icon: "🧪",
    effect: "Pre-workout boost. Performance +15%.",
  },
  {
    id: "protein",
    ...
    price: 40,
    icon: "🥛",
    effect: "+25g protein. STR recovery.",
  },
  {
    id: "creatine",
  ...
  },
  {
    ...
    price: 800,
    icon: "🧤",
    effect: "Deadlift grip +20%. Back engagement +10%.",
  },
  {
    id: "belt",
    name: "Shadow Power Belt",
    type: "equipment",
    grade: "epic",
    price: 2500,
    icon: "🦺",
    effect: "Core stability +25%. Unlock heavy lift quests.",
  },
  {
    id: "form-scroll",
    name: "Form Codex — Squat",
    type: "special",
    grade: "epic",
    price: 1500,
    icon: "📜",
    effect: "Master squat form. INT +5, LUK +2.",
  },
  {
    id: "dungeon-key",
    ...
    price: 5000,
    icon: "🔑",
    effect: "Unlock S-Rank dungeon. Reward multiplied ×3.",
  },
];
...
export default function StorePage() {
  ...
  const [tab, setTab] = useState<"consumable" | "equipment" | "special">(
    "consumable",
  );
      ...
      <div className="relative z-10 max-w-4xl mx-auto space-y-6">
        ...
        >
          ...
          <p className="font-mono text-xs text-slate-500 mt-1">
            Items are manifestations of mana. Only the Player can perceive this
            store.
          </p>
        </motion.div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                      <h3
                        className={clsx(
                          "font-cinzel text-sm font-bold truncate",
                          GRADE_COLOR[item.grade],
                        )}
                      >
                        {item.name}
                      </h3>
                      <span
                        className={clsx(
                          "font-mono text-xs uppercase tracking-wider flex-shrink-0",
                          GRADE_COLOR[item.grade],
                        )}
                      >
                        [{item.grade}]
