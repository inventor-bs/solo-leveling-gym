...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        system:
          "0 0 20px rgba(0, 212, 255, 0.3), 0 0 40px rgba(0, 212, 255, 0.1), inset 0 0 20px rgba(0, 212, 255, 0.05)",
        "system-hover":
          "0 0 30px rgba(0, 212, 255, 0.5), 0 0 60px rgba(0, 212, 255, 0.2)",
        purple:
          "0 0 20px rgba(123, 47, 190, 0.4), 0 0 40px rgba(123, 47, 190, 0.2)",
      ...
      backgroundImage: {
        "void-gradient":
          "radial-gradient(ellipse at top, #0D0D1A 0%, #080810 100%)",
        "purple-gradient": "linear-gradient(135deg, #7B2FBE 0%, #4A1080 100%)",
        "system-gradient":
          "linear-gradient(180deg, rgba(0,212,255,0.1) 0%, transparent 100%)",
        "scan-lines":
